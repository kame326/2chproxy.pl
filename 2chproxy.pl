...
my $PROXY_CONFIG  = {
  ...
  HTML2DAT_REGEX3 => '<span class="postid">(\d+)</span><span class="postusername"><b>(?:<a href="mailto:([^"]+)">((?:(?!</a>).)*)</a>|((?:(?!</span>).)*))</b></span></summary><span class="date">([^<]+)</span><span class="uid">([^<]*)</span>(?:<span class="be [^>]+><a href="https?://be\.\dch\.net/user/(\d+)"[^>]*>\?([^<]+)</a></span>)?</details><section class="post-content">((?:(?!</section>).)*)</section>',
